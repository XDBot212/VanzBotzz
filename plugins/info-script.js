...
ラ *New Script, Recode by VirzzModz*
*https://github.com/VanzBotzz*

Mau lewat MediaFire(Full Module)? Chat owner hehe.

ラ *OFFICIAL GROUP*
*https://chat.whatsapp.com/DkHeeBmNBLzFhKkSo2gznE*
━━━━━━❏`
  let _muptime
    if (process.send) {
      process.send('uptime')
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        ...
                        body: `ラ by VirzzModzz`,          previewType: 0,
                        thumbnail: await (await fetch(thumb)).buffer(),
                        mediaUrl: 'https://telegra.ph/file/1acefb470f7ca60f5d484.png'
