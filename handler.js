...
This command can only be used by *OWNER* !`,
        owner: `${nmsr}\n
This command can only be used by *Owner Bot* !`,
        mods: `${nmsr}\n 
This command can only be used by *Moderator* !`,
        premium: `${nmsr}\n
This command only can use *Premium* members!`,
        group: `${nmsr}\n
This command can only be used in groups !`,
        private: `${nmsr}\n
This command can only be used in Private Chat !`,
        admin: `${nmsr}\n
This command only be used by Group *Admin*!`,
        botAdmin: `${nmsr}\n
Make the bot *Admin* to use this command !`,
        nsfw: `${nmsr}\n
NSFW is not active, please contact Team Bot Discussion to activate this feature!`,
        rpg: `${nmsr}\n
RPG non-active, Please contact Team Bot Discussion to activate this feature!`,
        restrict: `${nmsr}\n
This feature has *disable* !`
    }[type]
    if (msg) return conn.sendButton(m.chat, danied, msg, `${imgr + 'Accses Danied'}`, [['MENU', '.menu'],['OWNER', '.owner']],m)
    
     let msgg = {
    	unreg: `${nmsr}\nPlease register to the database first to use this bot further *Click the button below*\n\n*You can follow the next verification steps*\n\nMan or Woman?`
}[type]
